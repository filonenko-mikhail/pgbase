...
class QMenu;
class QWebView;
class WebViewEditActionsManagerHelper : public EditActionsManagerHelper
{
  Q_OBJECT
public:
  explicit WebViewEditActionsManagerHelper(QObject* parent = 0);
  virtual ~WebViewEditActionsManagerHelper();
