...
//#include "private/editactionsmanagerhelper_p.h"
...
void ItemViewEditActionsManagerHelper::deactivate()
{
  ...
  if (model) {
    ...
    //disconnect(model->undoStack(), SIGNAL(canRedoChanged(bool)), this, SIGNAL(canRedoChanged(bool)));
  }
  itemView = 0;
}
...
WebViewEditActionsManagerHelper::WebViewEditActionsManagerHelper(QObject* parent)
  : EditActionsManagerHelper(parent)
{
...
WebViewEditActionsManagerHelper::~WebViewEditActionsManagerHelper()
{
  delete webMenu;
}

unsigned char WebViewEditActionsManagerHelper::approach(QWidget* widget) const
{
  return qobject_cast<QWebView*>(widget) ? 10 : 0;
}

void WebViewEditActionsManagerHelper::activateFor(QWidget* widget)
{
...
void WebViewEditActionsManagerHelper::deactivate()
{
  webView = 0;
}

bool WebViewEditActionsManagerHelper::canUndo() const
{
  return webView->pageAction(QWebPage::Undo)->isEnabled();
  return false;
}

bool WebViewEditActionsManagerHelper::canRedo() const
{
  return webView->pageAction(QWebPage::Redo)->isEnabled();
  return false;
}

bool WebViewEditActionsManagerHelper::canCut() const
{
  return webView->pageAction(QWebPage::Cut)->isEnabled();
  return false;
}

bool WebViewEditActionsManagerHelper::canCopy() const
{
  return webView->pageAction(QWebPage::Copy)->isEnabled();
  return false;
}

bool WebViewEditActionsManagerHelper::canPaste() const
{
  return webView->pageAction(QWebPage::Paste)->isEnabled();
  return false;
}

bool WebViewEditActionsManagerHelper::canClear() const
{
  //if (webView)
  //  return webView->pageAction(QWebPage::Re)->isEnabled();
  return false;
}

bool WebViewEditActionsManagerHelper::canSelectAll() const
{
  return webView->pageAction(QWebPage::SelectAll)->isEnabled();
  return false;
}

QList<QAction*> WebViewEditActionsManagerHelper::additionalActions() const
{
  QList<QAction*> result;
  {
    ...
    //    Stop,
    //    Reload,
    //webView->pageAction(QWebPage::SelectAll)->isEnabled();
    result.append(webView->pageAction(QWebPage::Back));
    result.append(webView->pageAction(QWebPage::Forward));
    result.append(webView->pageAction(QWebPage::Stop));
    result.append(webView->pageAction(QWebPage::Reload));
    result.append(webMenu->menuAction());
  }
  return false;
}

void WebViewEditActionsManagerHelper::undo()
{
  webView->triggerPageAction(QWebPage::Undo);
}

void WebViewEditActionsManagerHelper::redo()
{
  webView->triggerPageAction(QWebPage::Redo);
}

void WebViewEditActionsManagerHelper::copy()
{
  webView->triggerPageAction(QWebPage::Copy);
}

void WebViewEditActionsManagerHelper::paste()
{
  webView->triggerPageAction(QWebPage::Paste);
}

void WebViewEditActionsManagerHelper::clear()
{
  //webView->triggerPageAction(QWebPage::);
}

void WebViewEditActionsManagerHelper::selectAll()
{
  webView->triggerPageAction(QWebPage::SelectAll);
}

void WebViewEditActionsManagerHelper::aboutToShow()
{
  {
    /*
        ToggleBold,
        ...
        ToggleUnderline,
      */
    webMenu->addAction(webView->pageAction(QWebPage::ToggleBold));
    webMenu->addAction(webView->pageAction(QWebPage::ToggleItalic));
    webMenu->addAction(webView->pageAction(QWebPage::ToggleUnderline));
  }
}

void WebViewEditActionsManagerHelper::aboutToHide()
{
  {
    /*
        ToggleBold,
        ...
        ToggleUnderline,
      */
    webMenu->removeAction(webView->pageAction(QWebPage::ToggleBold));
    webMenu->removeAction(webView->pageAction(QWebPage::ToggleItalic));
    webMenu->removeAction(webView->pageAction(QWebPage::ToggleUnderline));
  }
}
