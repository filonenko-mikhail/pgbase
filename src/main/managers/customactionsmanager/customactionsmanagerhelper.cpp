...
WebViewCustomActionsManagerHelper::WebViewCustomActionsManagerHelper(QObject* parent)
  : CustomActionsManagerHelper(parent)
{
...
WebViewCustomActionsManagerHelper::~WebViewCustomActionsManagerHelper()
{
  delete webMenu;
}

bool WebViewCustomActionsManagerHelper::approach(QWidget* widget) const
{
  return qobject_cast<QWebView*>(widget);
}

void WebViewCustomActionsManagerHelper::activateFor(QWidget* widget)
{
...
void WebViewCustomActionsManagerHelper::deactivate();
{
  webView = 0;
}

QList<QAction*> WebViewCustomActionsManagerHelper::additionalActions() const
{
  QList<QAction*> result;
  if (webView) {
    //    Back,
...
void WebViewCustomActionsManagerHelper::aboutToShow()
{
  if (webView) {
    /*
        ToggleBold,
...
void WebViewCustomActionsManagerHelper::aboutToHide()
{
  if (webView) {
    /*
        ToggleBold,
