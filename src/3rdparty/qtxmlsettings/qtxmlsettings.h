...
class QTXMLSETTINGS_EXPORT QtXmlSettings:public QSettings
{
  Q_OBJECT
public:
  QtXmlSettings(const QString &organization,
             const QString &application , QObject *parent = 0)
    :QSettings(xml_format, QSettings::UserScope, organization, application, parent) {}
  ...
  QtXmlSettings(QObject * parent = 0):
    QSettings(xml_format, QSettings::UserScope, QCoreApplication::organizationName()
...
private:
  ...
  static void processWriteKey( QDomDocument& doc
