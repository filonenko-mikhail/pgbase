...
QtCheckBoxDelegate::QtCheckBoxDelegate(QObject *parent)
...
QWidget* QtCheckBoxDelegate::createEditor
    (QWidget* /*parent*/,
...
QRect QtCheckBoxDelegate::checkRect
    (const QStyleOptionViewItem& option,
...
bool QtCheckBoxDelegate::editorEvent
    (QEvent* event,
